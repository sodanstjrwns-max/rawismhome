...
const seoMeta: Record<Language, {
  ...
  ko: {
    ...
    description: '서울 연남동 프리미엄 샴페인바 ROWISM The Black. 당일 도축 온도체 한우 뭉티기와 샴페인이 만나는 특별한 밤. 체온이 남아있는 신선함 그대로, 부라타 치즈와 트러플의 조화. 홍대입구역 5분, 8석 한정 예약제.',
      ...
      <html lang={meta.htmlLang} data-lang={lang}>
        <head>
          ...
          <script dangerouslySetInnerHTML={{__html: `
            ...
            window.ROWISM_INITIAL_LANG = '${lang}';
          `}} />
